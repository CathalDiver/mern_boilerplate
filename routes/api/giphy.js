...
router.get("/", auth, async (req, res) => {
	try {
		axios
			.get(
				"http://api.giphy.com/v1/gifs/search?q=ryan+gosling&api_key=LEls10pQ1lqL1lxLehiPoD0P61SpGcQK&limit=6"
			)
			.then(response => {
...
router.post("/search", async (req, res) => {
	...
	const str2 = "&api_key=LEls10pQ1lqL1lxLehiPoD0P61SpGcQK&limit=6";
